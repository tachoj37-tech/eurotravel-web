...
window.UNIDADES = [
  ...
  { id: 'sprinter', cat: 'sprinter', cotizadorAutomatico: true, tag: 'Sprinter · Grupos pequeños', name: 'Sprinter', cap: '10 a 20 pasajeros', max: 20, img: 'sprinter',
    ...
    spec: [['i-users', '10 a 20 pasajeros'], ['i-snow', 'Aire acondicionado'], ['i-seat', 'Asientos reclinables'], ['i-tv', 'Pantalla y sistema de audio'], ['i-bag', 'Espacio para equipaje'], ['i-shield', 'Seguro de viajero incluido'], ['i-briefcase', 'Traslados ejecutivos y eventos'], ['i-route', 'Ágil en ciudad y carretera']] },
