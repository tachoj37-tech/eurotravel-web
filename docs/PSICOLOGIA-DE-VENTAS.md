...
Este texto es el que lee la IA en cada mensaje (vive en `api/_psicologia.js`; si cambias uno, cambia el otro). Reescrito el 8-sep-2026 por dictado del dueño («¿cuál fiesta? elimina eso y arregla toda tu psicología y marketing de ventas»): la versión anterior era un manual de técnicas con frases hechas por destino y por ocasión, y la IA las pegaba tal cual aunque el cliente no hubiera dicho nada de eso. Ahora son principios de vendedor, sin frases para copiar, con la regla de nunca presumir nada que el cliente no haya dicho y de nunca inventar escasez, descuentos ni datos de la empresa.
