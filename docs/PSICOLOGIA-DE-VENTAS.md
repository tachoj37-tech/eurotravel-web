# Psicología de ventas aplicada al agente de WhatsApp

Este texto es el que lee la IA en cada mensaje (vive en `api/_psicologia.js`; si cambias uno, cambia el otro). Base: el marco dictado por el dueño el 6-sep-2026, más el mercado mexicano y tapatío, con la regla de nunca inventar escasez, descuentos ni datos de la empresa.
