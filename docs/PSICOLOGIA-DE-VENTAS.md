...
Este texto es el que lee la IA en cada mensaje (vive en `api/_psicologia.js`; si cambias uno, cambia el otro). Dictado del dueño (5-sep-2026): todos los conceptos de la psicología de las ventas, aplicados; sin inventar escasez, descuentos ni datos.
