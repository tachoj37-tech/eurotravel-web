...
| **Movimientos** | Los traslados dentro del destino, capturados en el paso 2 y cobrados **por día**. El precio sale de la **banda de horas** del día. Cada día cubre 8 horas dentro de la zona metropolitana del destino, o 40 km a la redonda del centro: eso es texto del contrato, no una cuenta — aquí no se valida ninguna coordenada. No puede haber más días con movimiento que noches en destino, y ese tope lo aplican la pantalla **y** el servidor, con el mismo número. |
